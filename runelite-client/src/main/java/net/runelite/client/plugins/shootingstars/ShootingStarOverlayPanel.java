...
public class ShootingStarOverlayPanel extends OverlayPanel
{
	private final ShootingStarPlugin plugin;

	@Inject
	private ShootingStarOverlayPanel(ShootingStarPlugin plugin)
	{
		super(plugin);
		this.plugin = plugin;
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		{
			ShootingStarData soonest = plugin.getStarData().get(0);
